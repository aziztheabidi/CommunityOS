...
('evt_medical_camp', 'soc_demo_jaffar_e_tayyar', 'res_sara_malik', 'Cardiology Screening Camp', 'Free resident health screening', 'Walk-in cardiology checks with triage and referrals.', 'Community Center Hall', 'area_block_a1', '{"type":"Point","coordinates":[67.0795,24.9090]}'::jsonb, now() + interval '3 days', now() + interval '3 days' + interval '3 hours', 80, true, now(), now()),
('evt_tax_clinic', 'soc_demo_jaffar_e_tayyar', 'res_nadia_imran', 'SME Tax Q&A', 'Evening clinic for local business owners', 'Bring questions on filings, invoices, and payroll basics.', 'Office Suite E-03', 'area_sector_e', '{"type":"Point","coordinates":[67.0855,24.9034]}'::jsonb, now() + interval '6 days', now() + interval '6 days' + interval '2 hours', 12, true, now(), now()),
('evt_park_cleanup', 'soc_demo_jaffar_e_tayyar', 'res_fatima_zahra', 'Sector B Park Cleanup', 'Volunteer morning cleanup', 'Gloves and bags provided. Families welcome.', 'Sector B Central Park', 'area_block_b1', '{"type":"Point","coordinates":[67.0805,24.9072]}'::jsonb, now() + interval '10 days', now() + interval '10 days' + interval '2 hours', 40, true, now(), now()),
('evt_youth_coding', 'soc_demo_jaffar_e_tayyar', 'res_ahmed_khan', 'Youth Coding Meetup', 'Intro React session for teens', 'Bring a laptop. Mentors from the society tech circle.', 'School Lab · Sector C', 'area_sector_c', '{"type":"Point","coordinates":[67.0798,24.9078]}'::jsonb, now() + interval '14 days', now() + interval '14 days' + interval '2 hours', 25, true, now(), now()),
('evt_trades_fair', 'soc_demo_jaffar_e_tayyar', 'res_usman_raza', 'Trades & Home Services Fair', 'Meet local electricians, plumbers, and contractors', 'Open booths near Gate 2 plaza.', 'Near Gate 2', 'area_block_a1', '{"type":"Point","coordinates":[67.0789,24.9089]}'::jsonb, now() + interval '21 days', now() + interval '21 days' + interval '4 hours', 100, true, now(), now()),
('evt_dental_day', 'soc_demo_jaffar_e_tayyar', 'res_hana_qureshi', 'Family Dental Awareness Day', 'Oral health tips and free checkups', 'Priority for households with children.', 'SmileCare Dental', 'area_sector_c', '{"type":"Point","coordinates":[67.0798,24.9078]}'::jsonb, now() + interval '28 days', now() + interval '28 days' + interval '3 hours', 30, true, now(), now())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, "startsAt" = EXCLUDED."startsAt", "updatedAt" = now();
