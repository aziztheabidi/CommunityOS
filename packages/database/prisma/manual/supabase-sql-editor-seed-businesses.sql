...
('biz_plaza_market', 'soc_demo_jaffar_e_tayyar', 'bcat_retail', 'Plaza Market Store', 'plaza-market-store', 'Everyday grocery and household goods.', 'Resident-owned retail shop serving Sector D.', '+92-300-2200001', 'area_block_d1', 'Plaza Lane, Block D1', '{"type":"Point","coordinates":[67.202885,24.87946]}'::jsonb, true, true, true, 'verified', 'members', now(), now()),
('biz_smilecare', 'soc_demo_jaffar_e_tayyar', 'bcat_health', 'SmileCare Dental', 'smilecare-dental', 'Family dentistry inside the society.', 'Preventive and restorative dental care with resident hours.', '+92-300-2200002', 'area_sector_c', 'Clinic Row, Sector C', '{"type":"Point","coordinates":[67.190885,24.88046]}'::jsonb, true, false, true, 'verified', 'members', now(), now()),
('biz_imran_advisory', 'soc_demo_jaffar_e_tayyar', 'bcat_professional', 'Imran Advisory', 'imran-advisory', 'Tax and SME accounting.', 'Bookkeeping, filings, and advisory for local businesses.', '+92-300-2200003', 'area_sector_e', 'Office Suite E-03', '{"type":"Point","coordinates":[67.208885,24.88046]}'::jsonb, true, false, false, 'verified', 'members', now(), now()),
('biz_raza_electrical', 'soc_demo_jaffar_e_tayyar', 'bcat_services', 'Raza Electrical Services', 'raza-electrical', 'Licensed residential electrical work.', 'Installations, repairs, and emergency call-outs within the society.', '+92-300-2200004', 'area_sector_e', 'Sector E service lane', '{"type":"Point","coordinates":[67.209885,24.87946]}'::jsonb, true, false, true, 'pending', 'members', now(), now()),
('biz_abbas_plumbing', 'soc_demo_jaffar_e_tayyar', 'bcat_services', 'Abbas Plumbing', 'abbas-plumbing', 'Emergency and scheduled plumbing.', 'Trusted local plumber for households and commercial units.', '+92-300-2200005', 'area_block_b2', 'Block B2 workshops', '{"type":"Point","coordinates":[67.198885,24.89166]}'::jsonb, true, false, true, 'verified', 'members', now(), now()),
('biz_corner_cafe', 'soc_demo_jaffar_e_tayyar', 'bcat_food', 'Corner Café', 'corner-cafe', 'Neighborhood café near Gate 2.', 'Tea, snacks, and light meals for residents and visitors.', '+92-300-2200006', 'area_block_a1', 'Near Gate 2', '{"type":"Point","coordinates":[67.192885,24.87626]}'::jsonb, true, true, false, 'unverified', 'members', now(), now())
